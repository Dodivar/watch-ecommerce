...
export default {
  ...
  items: [
    ...
    },
    {
      ...
      answer: t({
        fr: "Oui, <strong>toutes nos montres sont authentifiées</strong> par nos experts avant d'être proposées, qu'il s'agisse de notre collection en stock ou de montres trouvées via notre service de recherche personnalisée. Nous vérifions l'authenticité, l'état, et l'historique de chaque pièce. Nous proposons également une garantie sur nos transactions et nous engageons sur la qualité et l'authenticité de chaque pièce que nous proposons.",
        en: 'Yes — <strong>every watch is authenticated</strong> by our experts before being offered, whether it comes from our in-stock collection or from our personalised sourcing service. We verify the authenticity, condition and history of each piece. We also provide a warranty on our transactions and stand behind the quality and authenticity of everything we offer.',
        de: 'Ja, <strong>alle unsere Uhren werden von unseren Experten authentifiziert</strong>, bevor wir sie anbieten — ob aus unserer Lagerkollektion oder über die persönliche Uhrensuche beschafft. Wir prüfen Echtheit, Zustand und Historie jedes Stücks. Zudem gewähren wir eine Garantie auf unsere Transaktionen und stehen für Qualität und Echtheit jedes angebotenen Stücks ein.',
      }),
    },
    {
      id: 8,
