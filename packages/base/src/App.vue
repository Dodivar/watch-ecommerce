...
<template>
  ...
  <MainNavMobile
    ...
    :show-social="Boolean(site.social?.show?.header)"
  />
    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16 gap-2">
        ...
        <div class="flex items-center gap-1 shrink-0">
          <!-- Réseaux sociaux en en-tête : opt-in par vitrine (`social.show.header`).
               `text-text-main` suffit — le thème sombre le repeint en blanc. -->
          <SocialIconLinks
            v-if="site.social?.show?.header"
            class="hidden md:flex"
            link-class="p-2 rounded-lg text-text-main hover:bg-cream-100 transition-colors"
          />
      ...
      <div :class="isAdmin ? 'grid md:grid-cols-5 gap-8' : 'grid md:grid-cols-4 gap-8'">
        ...
        <div>
          ...
          <div class="space-y-2 text-white/90">
            ...
            <!-- Une vitrine sans adresse publique (rendez-vous en lieu convenu) annonce
                 ses réseaux à la place : la colonne garde un moyen de nous joindre. -->
            <p v-if="site.contact?.footerAddressHtml" class="flex items-start">
            ...
            <template v-else>
              ...
              >
                ...
                {{ suivezNous.instagramHandle || 'Instagram' }}
              </a>
              <a
                v-if="suivezNous?.facebookUrl"
                :href="suivezNous.facebookUrl"
              ...
              >
                ...
                {{ suivezNous.facebookHandle || 'Facebook' }}
              </a>
            </template>
          </div>
        </div>
        ...
        <div v-if="isAdmin && features.admin" class="border-l border-white/20 pl-4">
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li v-if="features.estimation">
              <RouterLink to="/rachat" class="text-white/90 hover:text-white transition-colors"
                >Rachat</RouterLink
              >
            </li>
            <li v-if="features.estimationProcess">
              <RouterLink to="/rachat/processus" class="text-white/90 hover:text-white transition-colors"
                >Rachat Processus</RouterLink
              >
            </li>
