...
<template>
  <!-- `admin-shell` / `admin-topbar` : points d'accroche du thème (voir theme-dark.css). -->
  <div class="admin-shell flex h-screen flex-col overflow-hidden bg-cream lg:flex-row">
