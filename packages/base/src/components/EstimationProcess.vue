      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-md shadow-2xl p-8 md:p-12 space-y-8">
          ...
          <div class="prose prose-lg max-w-none">
            <p class="text-lg text-text-main/85 leading-relaxed">
          ...
          <div class="space-y-6">
            ...
            <div class="flex gap-6">
              ...
              <div class="flex-1">
                ...
                <p class="text-text-main/85 leading-relaxed">
            ...
            <div class="grid md:grid-cols-2 gap-6">
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-muted">Certaines marques et modèles emblématiques conservent mieux leur valeur.</p>
                </div>
              </div>
              <div class="flex items-start gap-3">
                <CheckCircle2 class="w-6 h-6 text-primary flex-shrink-0 mt-1" :stroke-width="2" />
                <div>
                  ...
                  <p class="text-sm text-muted">Les éditions limitées et les modèles anciens peuvent avoir une valeur supérieure.</p>
                </div>
              </div>
              <div class="flex items-start gap-3">
                <CheckCircle2 class="w-6 h-6 text-primary flex-shrink-0 mt-1" :stroke-width="2" />
                <div>
                  ...
                  <p class="text-sm text-muted">L'usure, les rayures et l'entretien régulier impactent la valeur.</p>
                </div>
              </div>
              <div class="flex items-start gap-3">
                <CheckCircle2 class="w-6 h-6 text-primary flex-shrink-0 mt-1" :stroke-width="2" />
                <div>
                  ...
                  <p class="text-sm text-muted">Boîte, papiers, étiquettes et certificats augmentent significativement la valeur.</p>
                </div>
              </div>
              <div class="flex items-start gap-3">
                <CheckCircle2 class="w-6 h-6 text-primary flex-shrink-0 mt-1" :stroke-width="2" />
                <div>
                  ...
                  <p class="text-sm text-muted">Un historique documenté peut ajouter de la valeur à certaines pièces.</p>
                </div>
              </div>
              <div class="flex items-start gap-3">
                <CheckCircle2 class="w-6 h-6 text-primary flex-shrink-0 mt-1" :stroke-width="2" />
                <div>
                  ...
                  <p class="text-sm text-muted">Les tendances actuelles et la demande influencent les prix.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="border-l-4 border-primary pl-6 py-4">
            ...
            <ul class="space-y-3 text-text-main/85">
