...
export const WATCH_SPEC_VOCABULARY = {
  ...
  color: [
    ...
    { key: 'watchSpec.color.silver', aliases: ['argent', 'argente', 'argentee'] },
    ...
    { key: 'watchSpec.color.red', aliases: ['rouge'] },
    { key: 'watchSpec.color.burgundy', aliases: ['bordeaux', 'bordeau'] },
    ...
    { key: 'watchSpec.color.gold', aliases: ['dore', 'doree', 'or'] },
    { key: 'watchSpec.color.roseGold', aliases: ['or rose'] },
    { key: 'watchSpec.color.pink', aliases: ['rose'] },
    { key: 'watchSpec.color.purple', aliases: ['violet', 'violette', 'mauve'] },
    { key: 'watchSpec.color.turquoise', aliases: ['turquoise'] },
    { key: 'watchSpec.color.beige', aliases: ['beige'] },
    { key: 'watchSpec.color.orange', aliases: ['orange'] },
    { key: 'watchSpec.color.yellow', aliases: ['jaune'] },
    { key: 'watchSpec.color.copper', aliases: ['cuivre', 'cuivree'] },
  ],
