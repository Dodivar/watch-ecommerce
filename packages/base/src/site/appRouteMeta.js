...
export const APP_ROUTE_META = [
  ...
  { path: '/collection/:brandSlug', feature: 'collection' },
  ...
  { path: '/admin/home-collection', feature: 'admin', requiresFeatures: ['homeCollectionHighlight'] },
  { path: '/admin/home-vitrine', feature: 'admin', requiresFeatures: ['homeVitrine'] },
  { path: '/admin/home-carousel', feature: 'admin', requiresFeatures: ['homeCarousel'] },
